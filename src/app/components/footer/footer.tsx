            ...
            <div className="mx-auto max-w-screen-lg min-h-full mt-3 p-5">
                        <div className="flex flex-col items-start sm:flex-row sm:space-x-12">
                            ...
                            <div className="flex flex-col items-center mt-2 m-1 p-2">
                                <p className="text-xl font-semibold text-black">Sitemap</p>
                            ...
                            <div className="flex flex-col items-center m-1 p-2">
                                <p className="text-xl font-semibold text-black">Institucional</p>
                            ...
                            <div className="flex flex-col items-center m-1 p-2">
                                <p className="text-xl font-semibold text-black">Informações</p>
                                <p>(19) 97124-0437</p>
